print("Welcome to AITS - Physics generation code! please answer the following questions.")
...
final_html_code += "All India Test Series - Physics" #title
