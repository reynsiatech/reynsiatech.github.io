print("Welcome to AITS - Chemistry generation code! please answer the following questions.")
...
final_html_code += "All India Test Series - Chemistry" #title
